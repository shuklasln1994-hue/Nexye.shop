...
import { faShippingFast, faShieldAlt, faHeadset, faBoxOpen, faTruck, faMapMarkedAlt, faClock, faCheckCircle, faDollarSign, faChartLine, faUsers, faGlobe, faEnvelope, faPhone, faBuilding, faComments } from '@fortawesome/free-solid-svg-icons';
      ...
      <div style={styles.body}>
        ...
        <nav style={styles.nav}>
          <div style={styles.navContainer}>
            {/* Logo */}
            <a href="/" style={styles.logo} onClick={() => router.push('/')}>
              📦 NEXYE
            </a>
        ...
        <section id="services" style={{...styles.section, ...styles.sectionGray}}>
          <div style={styles.container}>
            ...
            <div style={styles.servicesGrid}>
              {/* Service Card 1: Standard Delivery */}
              <div style={styles.serviceCard}>
                <h3 style={styles.serviceTitle}>Standard Delivery</h3>
                <p style={styles.serviceDescription}>2-4 Business Days</p>
                <p style={styles.servicePrice}>Starting ₹270</p>
                <ul style={styles.serviceFeatures}>
                  <li><FontAwesomeIcon icon={faCheckCircle} color="#10b981" /> Nationwide coverage</li>
                  <li><FontAwesomeIcon icon={faCheckCircle} color="#10b981" /> SMS updates</li>
                  <li><FontAwesomeIcon icon={faCheckCircle} color="#10b981" /> Insurance included</li>
                  <li><FontAwesomeIcon icon={faCheckCircle} color="#10b981" /> Proof of delivery</li>
                </ul>
                <button
                  onClick={() => router.push('/order-form')}
              ...
              {/* Service Card 2: Express Delivery */}
              <div style={{...styles.serviceCard, ...styles.serviceCardPopular}}>
                <div style={styles.popularBadge}>Most Popular</div>
                <h3 style={styles.serviceTitle}>Express Delivery</h3>
                <p style={styles.serviceDescription}>1-2 Business Days</p>
                <p style={styles.servicePrice}>Starting ₹450</p>
                <ul style={styles.serviceFeatures}>
                  <li><FontAwesomeIcon icon={faCheckCircle} color="#10b981" /> Priority handling</li>
                  <li><FontAwesomeIcon icon={faCheckCircle} color="#10b981" /> Faster transit</li>
                  <li><FontAwesomeIcon icon={faCheckCircle} color="#10b981" /> Live tracking</li>
                  <li><FontAwesomeIcon icon={faCheckCircle} color="#10b981" /> Premium support</li>
                </ul>
                <button
                  onClick={() => router.push('/order-form')}
                  style={styles.primaryButton}
              ...
              {/* Service Card 3: Same Day Delivery */}
              <div style={styles.serviceCard}>
                <h3 style={styles.serviceTitle}>Same Day Delivery</h3>
                <p style={styles.serviceDescription}>Within City Limits</p>
                <p style={styles.servicePrice}>Starting ₹200</p>
                <ul style={styles.serviceFeatures}>
                  <li><FontAwesomeIcon icon={faCheckCircle} color="#10b981" /> Ultra-fast delivery</li>
                  <li><FontAwesomeIcon icon={faCheckCircle} color="#10b981" /> Real-time updates</li>
                  <li><FontAwesomeIcon icon={faCheckCircle} color="#10b981" /> Dedicated support</li>
                  <li><FontAwesomeIcon icon={faCheckCircle} color="#10b981" /> Emergency service</li>
                </ul>
                <button
                  onClick={() => router.push('/order-form')}
                  style={styles.secondaryButton}
